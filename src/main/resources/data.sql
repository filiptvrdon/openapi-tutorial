...
INSERT INTO todo (name, description, completed) VALUES
('Apicur.io', 'Create my first OpenAPI Spec', true);

INSERT INTO todo (name, description, completed) VALUES
('OAG Templating', 'Add DB persistance to my Springboot App', true);

INSERT INTO todo (name, description,completed) VALUES
('OpenApi Generator', 'Generate my OpenAPI Springboot App', true);
